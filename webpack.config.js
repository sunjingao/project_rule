...
const commonConfig = {
  ...
  resolve: {
    ...
    alias: {
      ...
      CommCode: path.resolve('./src/utils/CommCode'),
      CommRequest: path.resolve('./src/utils/CommRequest'),
      CommUtil: path.resolve('./src/utils/CommUtil'),
      CurSetting: path.resolve('./src/utils/CurSetting'),
      CommSavePoint: path.resolve('./src/utils/CommSavePoint'),
      CommErrorLog: path.resolve('./src/utils/CommErrorLog'),
    }
  },
